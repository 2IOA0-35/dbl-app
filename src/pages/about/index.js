...
export default function About() {
    return (
        <div className='container'>
            <Title style={{ padding: '20px', width: '100%', textAlign: 'center', color: 'white' }}>About the visualisations</Title>
            <Card className='left' title='Hierarchical Edge Bundling' cover={<img alt='Hierarchical Edge Bundling' style={{ width: '50%', marginLeft: 'auto', marginRight: 'auto' }} src='./res/HEB.png' />} extra={ <a href='https://observablehq.com/@d3/hierarchical-edge-bundling' target='_blank' rel='noreferrer'>Source</a>}>
                <Text>
            ...
            <Card className='right' title='Disjoint Force-Directed Graph' cover={<img alt='Hierarchical Edge Bundling' style={{ width: '50%', marginLeft: 'auto', marginRight: 'auto' }} src='./res/DFG.png' />} extra={ <a href='https://observablehq.com/@d3/disjoint-force-directed-graph' target='_blank' rel='noreferrer'>Source</a> }>
                <Text>
            ...
            <Card title='The D3 library' className='left' extra={ <a href='https://d3js.org' target='_blank' rel='noreferrer'>Source</a> }>
                <Text>
                    D3 is a javascript library which enables powerful visualisations in javascript apps.
                    ...
                    The library also has some examples of the visualisations used in this project, which allows for easy implementation into this webapp.<br/>
                    Since the team was not very experienced with visualizations for a webapp and the visualisations used in the project needed to be interactive D3 was an ideal choice for a visualisation library.
                </Text>
            </Card>
            ...
            <Card title='Christine Jacob' className='right'>
                <Text>
                    Here you can put a bit of text about yourself.
                </Text>
            </Card>
